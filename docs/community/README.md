...
|--------|---------|----------|----------|
| AMA trimestriel | Première semaine de chaque trimestre | Répondre aux questions de la communauté, présenter les avancées majeures et confirmer les priorités du trimestre. | Live stream (YouTube/Twitch) + notes publiées sur le repo (`docs/community/ama-notes/`). |
